...
abstract class EntityImporter extends BaseEntityImporter
{
    ...
    EntityImporter(IdMapper idMapper, PropertyValueLookup inputIdLookup, BatchingStoreBase stores, Monitor monitor, PageCacheTracer pageCacheTracer, MemoryTracker memoryTracker )
    {
