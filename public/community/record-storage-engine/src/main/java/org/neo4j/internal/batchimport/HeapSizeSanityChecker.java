 ...
 * Registers warnings onto a {@link ImportLogicMonitor.Monitor}.
 */
class HeapSizeSanityChecker
{
    ...
    HeapSizeSanityChecker( ImportLogicMonitor.Monitor monitor )
    {
        this( monitor, OsBeanUtil::getFreePhysicalMemory, Runtime.getRuntime()::maxMemory );
    }

    HeapSizeSanityChecker(ImportLogicMonitor.Monitor monitor, LongSupplier freeMemoryLookup, LongSupplier actualHeapSizeLookup )
    {
