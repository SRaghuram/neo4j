...
class EntityStateImpl implements EntityState
{
    ...
    public Iterable<StorageProperty> addedAndChangedProperties()
    {
        ...
        return Iterables.concat( toPropertyIterator( addedProperties ), toPropertyIterator( changedProperties ) );
    }
    ...
    private Iterable<StorageProperty> toPropertyIterator( LongObjectMap<Value> propertyMap )
    {
