...
import org.neo4j.kernel.impl.transaction.log.checkpoint.*;
...
import static org.neo4j.internal.index.label.TokenScanStore.*;
...
public class Database extends LifecycleAdapter
{
    ...
    public synchronized void start()
    {
        ...
        try
        {
            ...
            boolean storageExists = storageEngineFactory.storageExists( fs, databaseLayout, databasePageCache, getConfig() );
