...
public class FrekiNodeImporter extends FrekiEntityImporter{
    ...
    public FrekiNodeImporter(BatchingStoreBase basicNeoStore, IdMapper idMapper, PropertyValueLookup inputIdLookup, DataImporterMonitor monitor, PageCacheTracer pageCacheTracer, MemoryTracker memoryTracker) {
