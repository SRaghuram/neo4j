...
import org.neo4j.SFRS.kernel.impl.store.format.UnsupportedFormatCapabilityException;
import org.neo4j.SFRS.kernel.impl.store.format.standard.StandardFormatSettings;
...
import org.neo4j.SFRS.internal.recordstorage.RecordPropertyCursor;
...
public class PropertyStore extends CommonAbstractStore<PropertyRecord,NoStoreHeader>
{
            ...
            ImmutableSet<OpenOption> openOptions )
    {
        super( path, idFile, configuration, IdType.PROPERTY, idGeneratorFactory, pageCache, logProvider, TYPE_DESCRIPTOR,
                recordFormats.property(), NoStoreHeaderFormat.NO_STORE_HEADER_FORMAT, recordFormats.storeVersion(), openOptions );
    ...
    {
        return DynamicArrayStore.getRightArray( arrayStore.readFullByteArray( records, PropertyType.ARRAY, cursorTracer ) );
    }
