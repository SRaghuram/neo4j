...
public class RelationshipGroupGetter
{
            ...
            RecordAccess<RelationshipGroupRecord, Integer> relGroupRecords )
    {
        ...
        RecordAccess.RecordProxy<RelationshipGroupRecord, Integer> previous = null;
        RecordAccess.RecordProxy<RelationshipGroupRecord, Integer> current;
    ...
    public RecordAccess.RecordProxy<RelationshipGroupRecord, Integer> getOrCreateRelationshipGroup(
            RecordAccess.RecordProxy<NodeRecord,Void> nodeChange, int type, RecordAccess<RelationshipGroupRecord, Integer> relGroupRecords )
    {
    ...
    public static class RelationshipGroupPosition
    {
        ...
        public RelationshipGroupPosition( RecordAccess.RecordProxy<RelationshipGroupRecord, Integer> closestPrevious,
