...
import org.neo4j.SFRS.kernel.impl.store.format.RecordFormatPropertyConfigurator;
...
import org.neo4j.SFRS.kernel.impl.store.format.aligned.AlignedFormatFamily;
...
public class StoreFactory
{
            ...
            FileSystemAbstraction fileSystemAbstraction, LogProvider logProvider, PageCacheTracer cacheTracer )
    {
        this( directoryStructure, config, idGeneratorFactory, pageCache, fileSystemAbstraction,
                RecordFormatSelector.selectForStoreOrConfig( config, directoryStructure, fileSystemAbstraction, pageCache, logProvider, cacheTracer ),
