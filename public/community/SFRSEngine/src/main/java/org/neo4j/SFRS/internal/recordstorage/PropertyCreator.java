...
public class PropertyCreator
{
    ...
    public <P extends PrimitiveRecord> void primitiveSetProperty(
            RecordAccess.RecordProxy<P, ?> primitiveRecordChange, int propertyKey, Value value,
            RecordAccess<PropertyRecord, PrimitiveRecord> propertyRecords )
    {
        ...
        {
            RecordAccess.RecordProxy<PropertyRecord, PrimitiveRecord> proxy = propertyRecords.getOrLoad( prop, primitive, cursorTracer );
