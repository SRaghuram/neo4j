...
import org.neo4j.SFRS.internal.batchimport.*;
...
import static org.neo4j.SFRS.internal.batchimport.ImportMemoryCalculator.defensivelyPadMemoryEstimate;
import static org.neo4j.SFRS.internal.batchimport.ImportMemoryCalculator.estimatedCacheSize;
import static org.neo4j.internal.batchimport.cache.GatheringMemoryStatsVisitor.totalMemoryUsageOf;
import static org.neo4j.internal.helpers.Format.*;
...
public class HumanUnderstandableExecutionMonitor implements ExecutionMonitor
{
    ...
    public void done( boolean successful, long totalTimeMillis, String additionalInformation )
    {
        ...
        System.out.println();
        //if (!Config.isSFRSEngine)
            System.out.println( format( "IMPORT %s in %s. %s", successful ? "DONE" : "FAILED", duration( totalTimeMillis ), additionalInformation ) );
        //else
        //    System.out.println( format( "IMPORT SFRS %s in %s. %s", successful ? "DONE" : "FAILED", duration( totalTimeMillis ), additionalInformation ) );
    }
