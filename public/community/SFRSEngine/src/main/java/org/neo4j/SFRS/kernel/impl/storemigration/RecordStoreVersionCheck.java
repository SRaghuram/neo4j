...
import static org.neo4j.SFRS.kernel.impl.store.MetaDataStore.Position.STORE_VERSION;
import static org.neo4j.SFRS.kernel.impl.store.format.RecordFormatPropertyConfigurator.configureRecordFormat;
...
public class RecordStoreVersionCheck implements StoreVersionCheck
{
    ...
    {
        long record = MetaDataStore.getRecord( pageCache, metaDataFile, STORE_VERSION, cursorTracer, config.isSFRSEngine( databaseLayout.getDatabaseName() ) );
