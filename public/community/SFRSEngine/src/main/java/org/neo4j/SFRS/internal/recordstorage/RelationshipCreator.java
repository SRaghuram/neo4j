...
import org.neo4j.SFRS.kernel.impl.store.InvalidRecordException;
...
public class RelationshipCreator
{
    ...
    {
        RecordAccess.RecordProxy<NodeRecord,Void> firstNode = recordChangeSet.getNodeRecords().getOrLoad( firstNodeId, null, cursorTracer );
        RecordAccess.RecordProxy<NodeRecord,Void> secondNode =
    ...
    private void convertNodeToDenseIfNecessary( RecordAccess.RecordProxy<NodeRecord,Void> nodeChange,
            ...
            RecordAccess<RelationshipGroupRecord, Integer> relGroupRecords, ResourceLocker locks )
    {
        ...
        {
            RecordAccess.RecordProxy<RelationshipRecord, Void> relChange = relRecords.getOrLoad( relId, null, cursorTracer );
    ...
    private void connectRelationship(RecordAccess.RecordProxy<NodeRecord,Void> firstNodeChange,
                                     RecordAccess.RecordProxy<NodeRecord,Void> secondNodeChange, RelationshipRecord rel,
                                     RecordAccess<RelationshipRecord, Void> relRecords,
                                     RecordAccess<RelationshipGroupRecord, Integer> relGroupRecords, ResourceLocker locks )
    {
    ...
    private void connectRelationshipToDenseNode(RecordAccess.RecordProxy<NodeRecord,Void> nodeChange, RelationshipRecord rel,
                                                RecordAccess<RelationshipRecord, Void> relRecords,
                                                RecordAccess<RelationshipGroupRecord, Integer> relGroupRecords, ResourceLocker locks )
    {
    ...
    private void convertNodeToDenseNode(RecordAccess.RecordProxy<NodeRecord,Void> nodeChange, RelationshipRecord firstRel,
                                        RecordAccess<RelationshipRecord, Void> relRecords,
                                        RecordAccess<RelationshipGroupRecord, Integer> relGroupRecords, ResourceLocker locks )
    {
