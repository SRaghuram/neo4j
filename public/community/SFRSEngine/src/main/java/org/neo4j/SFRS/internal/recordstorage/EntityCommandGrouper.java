 ...
 * <ul>
 *     <li>Entity command ({@link Command.NodeCommand} or {@link Command.RelationshipCommand} followed by zero or more {@link Command.PropertyCommand property commands}
 *     for that entity</li>
 *     <li>zero or more {@link Command.PropertyCommand property commands}, all for the same node</li>
 * </ul>
 * <p>
...
public class EntityCommandGrouper<ENTITY extends Command>
{
     ...
     *     <li>Call {@link #nextProperty()} until it returns null, now all the {@link Command.PropertyCommand} in this group have been accessed</li>
     * </ol>
     */
    public class Cursor
    {
        ...
        public boolean nextEntity()
        {
            ...
            {
                Command.PropertyCommand firstPropertyCommand = (Command.PropertyCommand) commands[readCursor];
        ...
        public Command.PropertyCommand nextProperty()
        {
            if ( readCursor < writeCursor )
            {
                ...
                if ( command instanceof Command.PropertyCommand && ((Command.PropertyCommand) command).getEntityId() == currentEntity )
                {
                    readCursor++;
