...
public class RecordChangeSet implements RecordAccessSet
{
    ...
    public RecordChangeSet(
            RecordAccess.Loader<NodeRecord,Void> nodeLoader,
            RecordAccess.Loader<PropertyRecord,PrimitiveRecord> propertyLoader,
            RecordAccess.Loader<RelationshipRecord,Void> relationshipLoader,
            RecordAccess.Loader<RelationshipGroupRecord,Integer> relationshipGroupLoader,
            RecordAccess.Loader<SchemaRecord,SchemaRule> schemaRuleLoader,
            RecordAccess.Loader<PropertyKeyTokenRecord,Void> propertyKeyTokenLoader,
            RecordAccess.Loader<LabelTokenRecord,Void> labelTokenLoader,
