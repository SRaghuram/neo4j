 ...
 */
package org.neo4j.SFRS.kernel.impl.store.format.aligned;

import org.neo4j.SFRS.kernel.impl.store.format.standard.DynamicRecordFormat;
import org.neo4j.SFRS.kernel.impl.store.format.standard.NodeRecordFormat;
import org.neo4j.SFRS.kernel.impl.store.format.standard.RelationshipGroupRecordFormat;
import org.neo4j.SFRS.kernel.impl.store.format.standard.RelationshipTypeTokenRecordFormat;
import org.neo4j.SFRS.kernel.impl.store.format.BaseRecordFormats;
...
import org.neo4j.SFRS.kernel.impl.store.format.standard.LabelTokenRecordFormat;
import org.neo4j.SFRS.kernel.impl.store.format.standard.PropertyKeyTokenRecordFormat;
import org.neo4j.SFRS.kernel.impl.store.format.standard.PropertyRecordFormat;
import org.neo4j.SFRS.kernel.impl.store.format.standard.RelationshipRecordFormat;
import org.neo4j.SFRS.kernel.impl.store.format.standard.SchemaRecordFormat;
...
import org.neo4j.SFRS.kernel.impl.store.format.*;
...
public class PageAlignedV4_1 extends BaseRecordFormats
{
    ...
    {
        super( StoreVersion.ALIGNED_V4_1.versionString(), StoreVersion.ALIGNED_V4_1.introductionVersion(), 1,
