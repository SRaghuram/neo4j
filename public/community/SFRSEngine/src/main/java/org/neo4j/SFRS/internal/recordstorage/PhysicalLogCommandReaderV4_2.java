...
public class PhysicalLogCommandReaderV4_2 extends BaseCommandReader
{
    public static final CommandReader INSTANCE = new PhysicalLogCommandReaderV4_2();
    static final byte FORMAT_ID = 2;
