...
import static org.neo4j.SFRS.kernel.impl.store.PropertyStore.decodeString;
        ...
        extends CommonAbstractStore<RECORD,NoStoreHeader>
{
            ...
            ImmutableSet<OpenOption> openOptions )
    {
        super( path, idFile, configuration, idType, idGeneratorFactory, pageCache, logProvider, typeDescriptor,
                recordFormat, NoStoreHeaderFormat.NO_STORE_HEADER_FORMAT, storeVersion, openOptions );
    ...
    {
        RECORD record = getRecord( id, newRecord(), RecordLoad.NORMAL, cursorTracer );
    ...
    public void ensureHeavy( RECORD record, PageCursorTracer cursorTracer )
    {
        ...
        record.addNameRecords( nameStore.getRecords( record.getNameId(), RecordLoad.NORMAL, true, cursorTracer ) );
    }
