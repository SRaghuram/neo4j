...
import org.neo4j.SFRS.internal.batchimport.stats.DetailLevel;
...
public class SpectrumExecutionMonitor extends ExecutionMonitor.Adapter
{
    ...
    public void done( boolean successful, long totalTimeMillis, String additionalInformation )
    {
        ...
        //else
        //    out.println( format( "IMPORT SFRS %s in %s. %s", successful ? "DONE" : "FAILED", duration( totalTimeMillis ), additionalInformation ) );
    }
