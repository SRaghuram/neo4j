...
public class PropertyDeleter
{
            ...
            RecordAccess<PropertyRecord, PrimitiveRecord> propertyRecords )
    {
        ...
        {
            RecordAccess.RecordProxy<PropertyRecord, PrimitiveRecord> propertyChange = propertyRecords.getOrLoad( nextProp, primitive, cursorTracer );
     ...
     */
    public <P extends PrimitiveRecord> boolean removePropertyIfExists( RecordAccess.RecordProxy<P,Void> primitiveProxy,
     ...
     */
    public <P extends PrimitiveRecord> void removeProperty(RecordAccess.RecordProxy<P,Void> primitiveProxy, int propertyKey,
                                                           RecordAccess<PropertyRecord,PrimitiveRecord> propertyRecords )
    {
        PrimitiveRecord primitive = primitiveProxy.forReadingData();
        long propertyId = // propertyData.getId();
    ...
    private <P extends PrimitiveRecord> void removeProperty(RecordAccess.RecordProxy<P,Void> primitiveProxy, int propertyKey,
                                                            RecordAccess<PropertyRecord,PrimitiveRecord> propertyRecords, PrimitiveRecord primitive,
                                                            long propertyId )
    {
        RecordAccess.RecordProxy<PropertyRecord, PrimitiveRecord> recordChange = propertyRecords.getOrLoad( propertyId, primitive, cursorTracer );
    ...
    private <P extends PrimitiveRecord> void unlinkPropertyRecord( PropertyRecord propRecord,
            RecordAccess<PropertyRecord,PrimitiveRecord> propertyRecords,
            RecordAccess.RecordProxy<P, Void> primitiveRecordChange )
    {
