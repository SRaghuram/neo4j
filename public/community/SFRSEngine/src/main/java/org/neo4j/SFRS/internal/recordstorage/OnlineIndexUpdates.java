...
/**
 * Derives logical index updates from physical records, provided by {@link Command.NodeCommand node commands},
 * {@link Command.RelationshipCommand relationship commands} and {@link Command.PropertyCommand property commands}. For some
...
public class OnlineIndexUpdates implements IndexUpdates
{
    ...
    private void gatherUpdatesFor( long relationshipId, Command.RelationshipCommand relationshipCommand,
            EntityCommandGrouper<Command.RelationshipCommand>.Cursor propertyCommands )
    {
    ...
    private EntityUpdates.Builder gatherUpdatesFromCommandsForNode( long nodeId,
            Command.NodeCommand nodeChanges,
            EntityCommandGrouper<Command.NodeCommand>.Cursor propertyCommandsForNode )
    {
    ...
    private EntityUpdates.Builder gatherUpdatesFromCommandsForRelationship( long relationshipId, Command.RelationshipCommand relationshipCommand,
            EntityCommandGrouper<Command.RelationshipCommand>.Cursor propertyCommands )
    {
        long reltypeBefore;
        long reltypeAfter;
