...
import org.neo4j.SFRS.kernel.impl.store.format.standard.StandardV4_0;
...
class IdGeneratorMigratorTest
{
    ...
    void shouldFindAndStoreDeletedIds() throws IOException
    {
        ...
        migrator.migrate( Translate.translate( db ), Translate.translate( upgrade ), ProgressReporter.SILENT, StandardV3_4.STORE_VERSION, Standard.LATEST_STORE_VERSION );
        migrator.moveMigratedFiles( Translate.translate( upgrade ), Translate.translate( db ), StandardV3_4.STORE_VERSION, Standard.LATEST_STORE_VERSION );
