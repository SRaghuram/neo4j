...
import org.neo4j.SFRS.internal.recordstorage.RandomSchema;
import org.neo4j.SFRS.internal.recordstorage.SchemaStorage;
import org.neo4j.SFRS.internal.recordstorage.StoreTokens;
import org.neo4j.SFRS.kernel.impl.store.*;
import org.neo4j.SFRS.kernel.impl.store.allocator.ReusableRecordsCompositeAllocator;
import org.neo4j.SFRS.kernel.impl.store.format.RecordFormats;
import org.neo4j.SFRS.kernel.impl.store.format.standard.Standard;
import org.neo4j.SFRS.kernel.impl.store.format.standard.StandardV3_4;
import org.neo4j.SFRS.kernel.impl.store.record.DynamicRecord;
import org.neo4j.SFRS.kernel.impl.store.record.TokenRecord;
import org.neo4j.SFRS.kernel.impl.storemigration.legacy.SchemaRuleSerialization35;
...
import org.neo4j.io.layoutSFRS.Neo4jLayout;
...
import static org.neo4j.SFRS.kernel.impl.store.AbstractDynamicStore.allocateRecordsFromBytes;
import static org.neo4j.SFRS.kernel.impl.store.record.RecordLoad.CHECK;
...
class RecordStorageMigratorIT
{
        ...
        throws Exception
    {
        ...
        migrator.migrate( Translate.translate( databaseLayout ), Translate.translate( migrationLayout ), progressMonitor.startSection( "section" ), versionToMigrateFrom, getVersionToMigrateTo( check ) );
        ...
        migrator.moveMigratedFiles( Translate.translate( migrationLayout ), Translate.translate( databaseLayout ), versionToMigrateFrom, getVersionToMigrateTo( check ) );
        ...
        throws Exception
    {
        ...
        RecordStorageMigrator migrator = new RecordStorageMigrator( fs, pageCache, CONFIG, logService, jobScheduler, PageCacheTracer.NULL,
                batchImporterFactory, INSTANCE );
        migrator.migrate( Translate.translate( databaseLayout ), Translate.translate( migrationLayout ), progressMonitor.startSection( "section" ),
    ...
    void mustMigrateSchemaStoreToNewFormat( String version, LogPosition expectedLogPosition, Function<TransactionId, Boolean> txIdComparator ) throws Exception
    {
        ...
        migrator.migrate( Translate.translate( databaseLayout ), Translate.translate( migrationLayout ), reporter, versionToMigrateFrom, versionToMigrateTo );
        migrator.moveMigratedFiles( Translate.translate( migrationLayout ), Translate.translate( databaseLayout ), versionToMigrateFrom, versionToMigrateTo );
