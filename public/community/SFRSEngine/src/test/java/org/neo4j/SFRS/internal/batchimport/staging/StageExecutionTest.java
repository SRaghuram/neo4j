...
class StageExecutionTest
{
    ...
    void shouldOrderStepsAscending()
    {
        ...
        steps.add( ControlledStep.stepWithAverageOf( "step1", 0, 10 ) );
        steps.add( ControlledStep.stepWithAverageOf( "step2", 0, 5 ) );
        steps.add( ControlledStep.stepWithAverageOf( "step3", 0, 30 ) );
    ...
    void shouldOrderStepsDescending()
    {
        ...
        steps.add( ControlledStep.stepWithAverageOf( "step2", 0, 5 ) );
        steps.add( ControlledStep.stepWithAverageOf( "step3", 0, 30 ) );
        steps.add( ControlledStep.stepWithAverageOf( "step4", 0, 5 ) );
        StageExecution execution = new StageExecution( "Test", null, Configuration.DEFAULT, steps, Step.ORDER_SEND_DOWNSTREAM );
