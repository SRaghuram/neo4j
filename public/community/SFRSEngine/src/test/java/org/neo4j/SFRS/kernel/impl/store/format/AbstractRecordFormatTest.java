...
import org.neo4j.SFRS.kernel.impl.store.IntStoreHeader;
...
public abstract class AbstractRecordFormatTest
{
    ...
    private <R extends AbstractBaseRecord> void verifyWriteAndRead(Supplier<RecordFormat<R>> formatSupplier, Supplier<RecordGenerators.Generator<R>> generatorSupplier,
