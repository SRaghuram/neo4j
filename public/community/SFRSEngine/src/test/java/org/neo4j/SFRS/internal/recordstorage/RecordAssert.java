...
public class RecordAssert extends AbstractAssert<RecordAssert, RecordChangeSet>
{
    ...
    {
        DiffAssert<Iterable<? extends AbstractBaseRecord>> nodes = containsRecords( "nodes", RecordBuilders.filterType( expectedChanges, NodeRecord.class ) );
        DiffAssert<Iterable<? extends AbstractBaseRecord>> rels = containsRecords( "relationships", RecordBuilders.filterType( expectedChanges, RelationshipRecord.class ) );
        DiffAssert<Iterable<? extends AbstractBaseRecord>> groups =
                containsRecords( "relationship groups", RecordBuilders.filterType( expectedChanges, RelationshipGroupRecord.class ) );
        ...
        return new DiffAssert<>()
        {
            ...
            String diff( RecordChangeSet actual )
            {
                ...
                diff = nodes.diff( RecordBuilders.records( actual.getNodeRecords().changes() ) );
                if ( diff != null )
                {
                    return diff;
                }
