...
Neo4j is available both as a standalone server, or an embeddable component. You can https://neo4j.com/download/[download it] or https://neo4j.com/sandbox/[try online].
