...
import org.neo4j.consistency.oldCC.RecordType;
import org.neo4j.consistency.oldCC.checking.DynamicStore;
import org.neo4j.consistency.oldCC.checking.PrimitiveRecordCheck;
import org.neo4j.consistency.oldCC.checking.RecordCheck;
import org.neo4j.consistency.oldCC.checking.full.OwnerCheck;
import org.neo4j.consistency.oldCC.report.ConsistencyReport;
import org.neo4j.consistency.oldCC.store.RecordAccessStub;
...
import static org.neo4j.consistency.oldCC.checking.DynamicRecordCheckTest.configureDynamicStore;
import static org.neo4j.consistency.oldCC.checking.RecordCheckTestBase.NONE;
import static org.neo4j.consistency.oldCC.checking.RecordCheckTestBase.array;
import static org.neo4j.consistency.oldCC.checking.RecordCheckTestBase.check;
import static org.neo4j.consistency.oldCC.checking.RecordCheckTestBase.dummyDynamicCheck;
import static org.neo4j.consistency.oldCC.checking.RecordCheckTestBase.dummyNeoStoreCheck;
import static org.neo4j.consistency.oldCC.checking.RecordCheckTestBase.dummyNodeCheck;
import static org.neo4j.consistency.oldCC.checking.RecordCheckTestBase.dummyPropertyChecker;
import static org.neo4j.consistency.oldCC.checking.RecordCheckTestBase.dummyPropertyKeyCheck;
import static org.neo4j.consistency.oldCC.checking.RecordCheckTestBase.dummyRelationshipChecker;
import static org.neo4j.consistency.oldCC.checking.RecordCheckTestBase.dummyRelationshipLabelCheck;
import static org.neo4j.consistency.oldCC.checking.RecordCheckTestBase.inUse;
import static org.neo4j.consistency.oldCC.checking.RecordCheckTestBase.notInUse;
import static org.neo4j.consistency.oldCC.checking.RecordCheckTestBase.propertyBlock;
import static org.neo4j.consistency.oldCC.checking.RecordCheckTestBase.string;
