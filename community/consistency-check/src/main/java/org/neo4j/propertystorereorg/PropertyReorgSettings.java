...
/**
 * Settings for PropertyStore reorg
 */
@Description( "PropertyStore reorg configuration settings" )
public class PropertyReorgSettings
{
    public static final String COMMAND = "command";
    public static final String GET_PROPERTY_STATS = "get-propertystore-stats";
    public static final String REORG_PROPERTYSTORE = "reorg-propertystore";
    public static final String REORG_PROPERTYSTORE_LABEL = "reorg-propertystore-label";
    ...
    @Description( "Execution order of store cross-checks to be used when running PropertyStore reorg" )
