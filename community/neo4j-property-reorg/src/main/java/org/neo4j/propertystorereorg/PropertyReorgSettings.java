...
public class PropertyReorgSettings
{
    ...
    public static final String GET_PROPERTY_STATS = "check";
    public static final String REORG_PROPERTYSTORE = "reorg-by-id";
    public static final String REORG_PROPERTYSTORE_LABEL = "reorg-by-label";
