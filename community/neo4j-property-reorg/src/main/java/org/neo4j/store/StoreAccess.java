...
public class StoreAccess extends org.neo4j.kernel.impl.store.StoreAccess
{
    ...
    public enum STORES implements IStores
    {
        NodeStore
        {
            ...
            public int getProximity(StoreAccess storeAccess)
            {
                return ((NodeStore)storeAccess.getNodeStore()).getRecordsPerPage();//getPageSize()/storeAccess.getNodeStore().getRecordSize();
            }
        ...
        RelationshipStore
        {
            ...
            public int getProximity(StoreAccess storeAccess)
            {
                return ((RelationshipStore)storeAccess.getRelationshipStore()).getRecordsPerPage();//.getPageSize()/storeAccess.getRelationshipStore().getRecordSize();
            }
        ...
        PropertyStore
        {
            ...
            public int getProximity(StoreAccess storeAccess)
            {
                return ((PropertyStore)storeAccess.getPropertyStore()).getRecordsPerPage();//.getPageSize()/storeAccess.getPropertyStore().getRecordSize();
            }         
        },
        StringStore
        {
            ...
            public int getProximity(StoreAccess storeAccess)
            {
                return ((DynamicStringStore)storeAccess.getStringStore()).getRecordsPerPage();//.getPageSize()/storeAccess.getStringStore().getRecordSize();
            }
        },
        ArrayStore
        {
            ...
            public int getProximity(StoreAccess storeAccess)
            {
                return ((DynamicArrayStore)storeAccess.getArrayStore()).getRecordsPerPage();//.getPageSize()/storeAccess.getArrayStore().  getRecordSize();
            }
        };
    }
    ...
    public StoreAccess( NeoStores neoStore )
    {
        super( neoStore );
        this.initialize();
