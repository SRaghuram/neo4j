...
public class DataGeneratorInput implements Input
{
    ...
    {
        return replayable( () -> new RandomEntityDataGenerator( nodes, nodes, 10_000, seed, nodeHeader, labels, relationshipTypes,
    ...
    {
        return replayable( () -> new RandomEntityDataGenerator( nodes, relationships, 10_000, seed, relationshipHeader,
