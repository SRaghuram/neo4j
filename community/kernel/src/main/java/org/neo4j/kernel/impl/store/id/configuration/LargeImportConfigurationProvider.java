 ...
 */
public class LargeImportConfigurationProvider implements IdTypeConfigurationProvider
{
    ...
    private static final Set<IdType> TYPES_FOR_CONFIGURABLE_RECORDUNITS =
            Collections.unmodifiableSet( EnumSet.of( IdType.RELATIONSHIP ) );
    ...
    {
        return new IdTypeConfiguration( getTypesToReuse().contains( idType ), getTypesForDoubleRecordUnits().contains( idType ) );
    }
    ...
    protected Set<IdType> getTypesForDoubleRecordUnits()
    {
        return TYPES_FOR_CONFIGURABLE_RECORDUNITS;
    }
}
