...
import com.neo4j.bench.data.Augmenterizer.NullAugmenterizer;
import com.neo4j.bench.data.DataGenerator.GraphWriter;
import com.neo4j.bench.data.DataGenerator.LabelLocality;
import com.neo4j.bench.data.DataGenerator.Order;
import com.neo4j.bench.data.DataGenerator.PropertyLocality;
...
public class DataGeneratorConfigBuilder
{
     ...
     * <p>
     * {@link DataGenerator.Order#ORDERED}: order in which relationships were specified in
     * {@link DataGeneratorConfigBuilder#withOutRelationships(RelationshipDefinition...)}.
     * <p>
     * {@link DataGenerator.Order#SHUFFLED}: shuffled for each node.
     *
     ...
     * <p>
     * {@link DataGenerator.RelationshipLocality#CO_LOCATED_BY_START_NODE}: all outgoing
     ...
     * <p>
     * {@link DataGenerator.RelationshipLocality#SCATTERED_BY_START_NODE}: outgoing
     ...
     * <p>
     * {@link DataGenerator.RelationshipLocality} respects the
     * {@link DataGenerator.Order} set in
     * {@link DataGeneratorConfigBuilder#withRelationshipOrder(Order)}
     *
     ...
     * <p>
     * {@link DataGenerator.GraphWriter#TRANSACTIONAL}: every write operation is performed
     * within a transaction.
     * <p>
     * {@link DataGenerator.GraphWriter#BATCH}: write operations may be performed
     * non-transactionally (e.g., using batch inserter).
     * <p>
     * {@link DataGenerator.GraphWriter} respects the value set in
     * {@link DataGeneratorConfigBuilder#withGraphWriter(GraphWriter)}
     *
     * @param graphWriter
     * @return mutated version of the same builder instance
     */
     ...
     * <p>
     * {@link DataGenerator.Order#ORDERED}: order in which properties were specified in
     * {@link DataGeneratorConfigBuilder#withNodeProperties(PropertyDefinition...)} and
     * {@link DataGeneratorConfigBuilder#withRelationshipProperties(PropertyDefinition...)}.
     * <p>
     * {@link DataGenerator.Order#SHUFFLED}: shuffled for each node/relationship.
     *
     * @param propertyOrder
     * @return mutated version of the same builder instance
     */
     ...
     * <p>
     * {@link DataGenerator.PropertyLocality#CO_LOCATED_BY_ELEMENT}: all properties are added to
     ...
     * another in memory (in contiguous pages).
     * <p>
     * {@link DataGenerator.PropertyLocality#SCATTERED_BY_ELEMENT}: properties
     ...
     * <p>
     * {@link DataGenerator.PropertyLocality} respects the
     * {@link DataGenerator.Order} set in
     * {@link DataGeneratorConfigBuilder#withPropertyOrder(Order)}
     *
     ...
     * <p>
     * {@link DataGenerator.Order#ORDERED}: order in which labels were specified in
     * {@link DataGeneratorConfigBuilder#withLabels(Label...)}.
     * <p>
     * {@link DataGenerator.Order#SHUFFLED}: shuffled for each node.
     *
     * @param labelOrder
     ...
     * <p>
     * {@link DataGenerator.LabelLocality#CO_LOCATED_BY_NODE}: all labels are added to
     ...
     * another in memory (in contiguous pages).
     * <p>
     * {@link DataGenerator.LabelLocality#SCATTERED_BY_NODE}: labels
     ...
     * <p>
     * {@link DataGenerator.LabelLocality} respects the
     * {@link DataGenerator.Order} set in
     * {@link DataGeneratorConfigBuilder#withLabelOrder(Order)}
     *
     * @param labelLocality
     * @return mutated version of the same builder instance
     */
