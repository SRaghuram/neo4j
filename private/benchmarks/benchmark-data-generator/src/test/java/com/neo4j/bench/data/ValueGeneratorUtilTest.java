...
import static com.neo4j.bench.data.ValueGeneratorUtil.calculateCumulativeSelectivities;
import static com.neo4j.bench.data.ValueGeneratorUtil.makeSelectivityCumulative;
import static com.neo4j.bench.data.ValueGeneratorUtil.middlePad;
import static com.neo4j.bench.data.ValueGeneratorUtil.prefixPad;
import static com.neo4j.bench.data.ValueGeneratorUtil.suffixPad;
...
{
    @Test
    void shouldMakeSelectivityCumulative()
    {
    ...
    void shouldFailToMakeSelectivityCumulativeWhenTargetIsTooLow() throws IOException
    {
        ...
        assertThrows( DataGeneratorException.class, () ->
        {
    ...
    @Test
    void shouldCalculateCumulativeSelectivities()
    {
    ...
    @Test
    void calculateCumulativeSelectivitiesShouldBeSortedInAscendingOrder()
    {
    ...
    @Test
    void calculateCumulativeSelectivitiesOutputShouldBeSameSizeAsInput()
    {
        List<Double> originalSelectivities = Lists.newArrayList( 1D, 2D, 4D, 100D );
        List<Double> cumulativeSelectivities = calculateCumulativeSelectivities( originalSelectivities );
    ...
    @Test
    void calculateCumulativeSelectivitiesOutputShouldNotCrash()
    {
