...
public class Fulltext extends AbstractKernelBenchmark
{
    ...
    public static class TxState extends AbstractKernelBenchmark.TxState
    {
        ...
        public void setUp( Fulltext benchmark ) throws Exception
        {
            ...
            GraphDatabaseAPI api = (GraphDatabaseAPI) benchmark.db();
            DependencyResolver resolver = api.getDependencyResolver();
            accessor = resolver.resolveDependency( FulltextAdapter.class );
            tx = (KernelTransaction) kernelTx.unwrap();
        }

        public ScoreEntityIterator query( String query ) throws Exception
        {
            return accessor.query( tx, "ftsNodes", query );
        }
    ...
    {
        ScoreEntityIterator result = txState.query( highSelectivityValue.stringValue() );
    ...
    {
        ScoreEntityIterator result = txState.query( mediumSelectivityValue.stringValue() );
    ...
    {
        ScoreEntityIterator result = txState.query( lowSelectivityValue.stringValue() );
        try
        {
