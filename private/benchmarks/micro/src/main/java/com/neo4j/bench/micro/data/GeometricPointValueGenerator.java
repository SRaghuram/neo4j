...
public class GeometricPointValueGenerator implements ValueGeneratorFun<Point>
{
    ...
    GeometricPointValueGenerator( CoordinateReferenceSystem crs, double minX, double minY, double xStep, double yStep, long xStepCount, long totalStepCount )
    {
        this.crs = crs;
        this.minX = minX;
        this.minY = minY;
