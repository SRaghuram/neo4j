...
public class Neo4jServerDatabase implements ServerDatabase
{
    ...
    {
        return new Neo4jServerDatabase( boltUri, databaseName, pid );
    }
    ...
    private Neo4jServerDatabase( URI boltUri, DatabaseName databaseName, Pid pid )
    {
    ...
    private static class RowsScoreFun implements Neo4jServerDatabase.ScoreFun<Integer>
    {
    ...
    private static class PlanScoreFun implements Neo4jServerDatabase.ScoreFun<PlanOperator>
    {
