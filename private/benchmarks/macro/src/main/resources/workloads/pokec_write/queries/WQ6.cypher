MERGE (TheMatrix:Movie {title: 'The Matrix', released: 2001, tagline: 'Welcome to the Real World3'})
...
MERGE (AFewGoodMen:Movie {title:   'A Few Good Men', released: 1992,
...
MERGE (JonathanL:Person {name: 'Jonathan Lipnicki', born: 1990})
...
MERGE (StandByMe:Movie {title:   'Stand BY Me', released: 1995,
...
MERGE (AnnabellaS)-[:ACTED_IN {roles: ['Simon Bishop']}]->(WhatDreamsMayCome)
...
MERGE (SleeplessInSeattle:Movie {title:   'Sleepless in Seattle', released: 1993,
...
MERGE (ThatThingYouDo:Movie {title:   'That Thing You Do', released: 1996,
...
MERGE (SomethingsGottaGive:Movie {title: "Something's Gotta Give", released: 1975})
...
MERGE (CharlieWilsonsWar:Movie {title:   "Charlie Wilson's War", released: 2007,
