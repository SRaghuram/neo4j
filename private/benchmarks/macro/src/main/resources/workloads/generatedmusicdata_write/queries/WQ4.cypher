CREATE (TheMatrix:Movie {title:   'The Matrix', released: 2001,
                         tagline: 'Welcome to the Real World3'})
...
CREATE (StandByMe:Movie {title:   'Stand BY Me', released: 1995,
...
CREATE  (JessicaThompson)-[:REVIEWED {summary: 'An amazing journey', rating: 95}]->(CloudAtlas),
        ...
        (JessicaThompson)
          -[:REVIEWED {summary: "Slapstick redeemed only by the Robin Williams and Gene Hackman's stellar performances", rating: 45}]->(TheBirdcage),
