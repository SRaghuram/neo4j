...
public class Annotations
{
    ...
    private static Stream<Method> benchmarkMethodsFor( Class benchmarkClass )
    {
    ...
    public Annotations( String packageName )
    {
        ...
        this.benchmarkMethods = benchmarks
                .stream()
                .collect( toMap( identity(), b -> Annotations.benchmarkMethodsFor( b ).collect( toList() ) ) );
    ...
    private boolean hasAtLeastOneBenchmarkClass()
    {
        ...
        return benchmarkMethods.keySet().size() > 0;
    }
