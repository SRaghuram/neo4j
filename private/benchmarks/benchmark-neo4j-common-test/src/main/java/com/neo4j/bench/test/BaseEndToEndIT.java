...
{
    private final Neo4jRule neo4jBootstrap =
    ...
    @Rule
    public final RuleChain ruleChain = RuleChain.outerRule( temporaryFolder ).around( neo4jBootstrap );
    ...
    public void runReportBenchmarks() throws Exception
    {
        try ( Resources resources = new Resources( temporaryFolder.newFolder().toPath() ) )
        {
            ...
            try ( StoreClient storeClient = StoreClient.connect( neo4jBootstrap.boltURI(), "neo4j", "neo4j" ) )
            {
            ...
            try
            {
                ...
                Process process = new ProcessBuilder( processArgs( resources,
                                                                   ...
                                                                   baseDir,
                                                                   jvm,
                                                                   new ResultStoreCredentials( neo4jBootstrap.boltURI(), "neo4j", "neo4j" ) ) )
                ...
                assertStoreSchema( neo4jBootstrap.boltURI() );
