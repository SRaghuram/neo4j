...
public abstract class FindPid
{
    public FindPid tryFindFor( Jvm jvm, Instant start, Duration timeout, String processName )
    {
        try
        {
            while ( true )
            {
                FindPid jpsPid = processPid( jvm, processName );
    ...
    private FindPid processPid( Jvm jvm, String processName ) throws IOException, InterruptedException
    {
    ...
    FindPid tryPgrep( String processName ) throws IOException, InterruptedException
    {
    ...
    protected FindPid fromProcessOutput( String jpsOutput, String processName )
    {
        this.pid = jpsOutput.contains( processName )
    ...
    private FindPid( long pid, String jpsOutput )
    {
        this.pid = pid;
        this.jpsOutput = jpsOutput;
    }
