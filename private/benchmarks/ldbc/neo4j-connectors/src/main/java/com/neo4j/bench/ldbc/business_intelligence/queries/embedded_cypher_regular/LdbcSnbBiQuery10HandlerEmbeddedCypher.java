...
public class LdbcSnbBiQuery10HandlerEmbeddedCypher
        implements OperationHandler<LdbcSnbBiQuery10TagPerson,Neo4jConnectionState>
{
    private static final Neo4jSnbBiQuery10EmbeddedCypher QUERY = new Neo4jSnbBiQuery10EmbeddedCypher();
    ...
    {
        Retries<LdbcSnbBiQuery10TagPerson,List<LdbcSnbBiQuery10TagPersonResult>> retries =
