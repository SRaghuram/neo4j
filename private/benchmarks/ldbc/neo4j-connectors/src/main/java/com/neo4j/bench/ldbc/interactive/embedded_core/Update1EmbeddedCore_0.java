...
public class Update1EmbeddedCore_0 extends Neo4jUpdate1<Neo4jConnectionState>
{
    @Override
            ...
            throws DbException
    {
        ...
        Node city = Operators.findNode( connection.getTx(), Place.Type.City, Person.ID, operation.cityId() );
