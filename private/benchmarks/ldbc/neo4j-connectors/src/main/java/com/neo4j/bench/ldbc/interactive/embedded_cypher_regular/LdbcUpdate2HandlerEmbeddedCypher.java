...
public class LdbcUpdate2HandlerEmbeddedCypher
        implements OperationHandler<LdbcUpdate2AddPostLike,Neo4jConnectionState>
{
    private static final Neo4jUpdate2EmbeddedCypher QUERY = new Neo4jUpdate2EmbeddedCypher();
