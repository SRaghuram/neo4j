...
public class LdbcSnbBiQuery8HandlerEmbeddedCypher
        implements OperationHandler<LdbcSnbBiQuery8RelatedTopics,Neo4jConnectionState>
{
    private static final Neo4jSnbBiQuery8EmbeddedCypher QUERY = new Neo4jSnbBiQuery8EmbeddedCypher();
    ...
    {
        Retries<LdbcSnbBiQuery8RelatedTopics,List<LdbcSnbBiQuery8RelatedTopicsResult>> retries =
