...
public class LdbcQuery4HandlerEmbeddedCypher implements OperationHandler<LdbcQuery4,Neo4jConnectionState>
{
    private static final Neo4jLongQuery4EmbeddedCypher QUERY = new Neo4jLongQuery4EmbeddedCypher();
