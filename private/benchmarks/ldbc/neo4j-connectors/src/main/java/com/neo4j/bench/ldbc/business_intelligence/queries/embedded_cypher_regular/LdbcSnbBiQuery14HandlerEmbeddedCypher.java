...
public class LdbcSnbBiQuery14HandlerEmbeddedCypher
        implements OperationHandler<LdbcSnbBiQuery14TopThreadInitiators,Neo4jConnectionState>
{
    private static final Neo4jSnbBiQuery14EmbeddedCypher QUERY = new Neo4jSnbBiQuery14EmbeddedCypher();
    ...
    {
        Retries<LdbcSnbBiQuery14TopThreadInitiators,List<LdbcSnbBiQuery14TopThreadInitiatorsResult>> retries =
