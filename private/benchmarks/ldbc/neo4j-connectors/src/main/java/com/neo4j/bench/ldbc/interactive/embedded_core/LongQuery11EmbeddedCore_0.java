...
public class LongQuery11EmbeddedCore_0 extends Neo4jQuery11<Neo4jConnectionState>
{
    @Override
            ...
            throws DbException
    {
        ...
        Node country = Operators.findNode( connection.db(), Place.Type.Country, Place.NAME, operation.countryName() );
        ...
        MinMaxPriorityQueue<LdbcQuery11PreResult> preResults = MinMaxPriorityQueue
                ...
                .create();
        long mostRecentToleratedWorkFromYear = operation.workFromYear() - 1;
