...
public class Neo4jSnbBiQuery2EmbeddedCypher extends Neo4jSnbBiQuery2<Neo4jConnectionState>
{
            ...
            LdbcSnbBiQuery2TopTags operation ) throws DbException
    {
        ...
        params.put(
                START_DATE,
                LdbcDateCodec.utcToEncodedLongDateTime( operation.startDate(), connection.calendar() ) );
        params.put(
                END_DATE,
                LdbcDateCodec.utcToEncodedLongDateTime( operation.endDate(), connection.calendar() ) );
