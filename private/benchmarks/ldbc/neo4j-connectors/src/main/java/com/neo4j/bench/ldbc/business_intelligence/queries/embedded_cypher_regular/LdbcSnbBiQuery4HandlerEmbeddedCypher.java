...
public class LdbcSnbBiQuery4HandlerEmbeddedCypher
        implements OperationHandler<LdbcSnbBiQuery4PopularCountryTopics,Neo4jConnectionState>
{
    private static final Neo4jSnbBiQuery4EmbeddedCypher QUERY = new Neo4jSnbBiQuery4EmbeddedCypher();
    ...
    {
        Retries<LdbcSnbBiQuery4PopularCountryTopics,List<LdbcSnbBiQuery4PopularCountryTopicsResult>> retries =
