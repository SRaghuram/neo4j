...
public class LdbcQuery3HandlerEmbeddedCypher implements OperationHandler<LdbcQuery3,Neo4jConnectionState>
{
    private static final Neo4jLongQuery3EmbeddedCypher QUERY = new Neo4jLongQuery3EmbeddedCypher();
