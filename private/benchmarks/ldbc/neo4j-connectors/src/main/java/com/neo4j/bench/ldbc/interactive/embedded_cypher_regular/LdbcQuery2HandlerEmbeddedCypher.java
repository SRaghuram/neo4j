...
public class LdbcQuery2HandlerEmbeddedCypher implements OperationHandler<LdbcQuery2,Neo4jConnectionState>
{
    private static final Neo4jLongQuery2EmbeddedCypher QUERY = new Neo4jLongQuery2EmbeddedCypher();
