...
OPTIONAL MATCH (tag)<-[:COMMENT_HAS_TAG|POST_HAS_TAG]-(message:Message)-[:COMMENT_HAS_CREATOR|POST_HAS_CREATOR]->(person:Person)
...
OPTIONAL MATCH (tag)<-[:COMMENT_HAS_TAG|POST_HAS_TAG]-(message:Message)-[:COMMENT_HAS_CREATOR|POST_HAS_CREATOR]->(person)
         WHERE message.creationDate > $date
WITH
  tag,
  person,
...
OPTIONAL MATCH (tag)<-[:COMMENT_HAS_TAG|POST_HAS_TAG]-(message:Message)-[:COMMENT_HAS_CREATOR|POST_HAS_CREATOR]->(friend)
         WHERE message.creationDate > $date
WITH
  person,
  score,
