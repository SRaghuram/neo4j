...
public class EndToEndIT extends BaseEndToEndIT
{
                                        ...
                                        ResultStoreCredentials resultStoreCredentials ) throws IOException, DriverConfigurationException
    {
        ...
        Path benchmarkNeo4jConfig = temporaryFolder.newFile( "neo4j_benchmark.config" ).toPath();
        Neo4jConfigBuilder.empty()
                          .setDense( true )
                          .writeToFile( benchmarkNeo4jConfig );

        Path resultsDir = temporaryFolder.newFolder( "results_dir" ).toPath();
        Path workDir = temporaryFolder.newFolder( "work" ).toPath();

        Path ldbcCsvDir = temporaryFolder.newFolder( "ldbc_sf001_p006_regular_utc" ).toPath();
        ...
        Path ldbcConfigFile = temporaryFolder.newFile().toPath();
    ...
    private Path createLdbcStore( Resources resources ) throws IOException
    {
