...
public class InfrastructureResources
{
    ...
    {
        RetryPolicy<DescribeJobDefinitionsResult> retries = new RetryPolicy<DescribeJobDefinitionsResult>()
                .withDelay( Duration.ofSeconds( 5 ) )
                .withMaxAttempts( 10 );

        DescribeJobDefinitionsResult describeJobDefinitionsResult = Failsafe
                .with( retries )
                .get(
                        () -> awsBatch.describeJobDefinitions( new DescribeJobDefinitionsRequest()
                                                                       .withJobDefinitions(
                                                                               stackResource
