...
class SecurityGraphUpdatingCompatibility_42D4_IT extends SecurityGraphCompatibilityTestBase
{
    ...
    {
        initEnterprise( EnterpriseSecurityGraphComponentVersion.ENTERPRISE_SECURITY_42D4 );
    }
            ...
            try ( Transaction tx = system.beginTransaction( KernelTransaction.Type.EXPLICIT, LoginContext.AUTH_DISABLED ) )
            {
                ...
                assertThat( exception.getMessage() )
                        .contains( "This operation is not supported while running in compatibility mode with version " +
                                   EnterpriseSecurityGraphComponentVersion.ENTERPRISE_SECURITY_42D4.getDescription() );
            }
        }
    }
