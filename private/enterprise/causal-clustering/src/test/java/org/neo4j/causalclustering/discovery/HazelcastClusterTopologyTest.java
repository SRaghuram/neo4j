...
public class HazelcastClusterTopologyTest
{
    ...
    public void shouldValidateNullReadReplicaAttrMaps()
    {
        ...
        logProvider.rawMessageMatcher().assertContains( "Some, but not all, of the read replica attribute maps are null" );
    }
    ...
    public void shouldValidateReadReplicaAttrMapNullValues()
    {
        ...
        logProvider.rawMessageMatcher().assertContains( "Missing attribute %s for read replica" );
    }
    ...
    public void shouldLogAndExcludeMembersWithMissingAttributes() throws Exception
    {
        ...
        logProvider.rawMessageMatcher().assertContains( "Missing member attribute" );
    }
