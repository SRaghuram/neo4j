...
import org.neo4j.causalclustering.core.state.PerDatabaseCoreStateComponents;
...
{
    private final EnterpriseCoreEditionModule editionModule;
    ...
    public CoreDatabaseContext( PlatformModule platformModule, EnterpriseCoreEditionModule editionModule, String databaseName )
    {
