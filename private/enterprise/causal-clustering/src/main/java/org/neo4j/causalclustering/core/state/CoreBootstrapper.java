...
public class CoreBootstrapper
{
    ...
    void bootstrapActiveDatabase( LocalDatabase activeDatabase ) throws IOException, RecoveryRequiredException
    {
    ...
    void bootstrapSystemDatabase( LocalDatabase systemDatabase ) throws IOException, RecoveryRequiredException
    {
