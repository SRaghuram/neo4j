...
public class CoreStateFiles<STATE>
{
    ...
    public static final CoreStateFiles<ClusterStateVersion> VERSION =
            new CoreStateFiles<>( "version", GLOBAL, ClusterStateVersionMarshal.INSTANCE, CoreStateType.VERSION );
    ...
    public static final CoreStateFiles<GlobalSessionTrackerState> SESSION_TRACKER =
            new CoreStateFiles<>( "session-tracker", DATABASE, GlobalSessionTrackerState.Marshal.INSTANCE, global_session_tracker_state_size,
                    CoreStateType.SESSION_TRACKER );
    public static final CoreStateFiles<RaftCoreState> RAFT_CORE_STATE =
            new CoreStateFiles<>( "core", DATABASE, RaftCoreState.Marshal.INSTANCE, CoreStateType.RAFT_CORE_STATE );
    ...
    public static final CoreStateFiles<TermState> RAFT_TERM =
            new CoreStateFiles<>( "term", DATABASE, TermState.Marshal.INSTANCE, term_state_size, CoreStateType.RAFT_TERM );
    public static final CoreStateFiles<VoteState> RAFT_VOTE =
            new CoreStateFiles<>( "vote", DATABASE, VoteState.Marshal.INSTANCE, vote_state_size, CoreStateType.RAFT_VOTE );
    public static final CoreStateFiles<RaftMembershipState> RAFT_MEMBERSHIP =
            new CoreStateFiles<>( "membership", DATABASE, RaftMembershipState.Marshal.INSTANCE, raft_membership_state_size, CoreStateType.RAFT_MEMBERSHIP );
    ...
    public static final CoreStateFiles<QuarantineMarker> QUARANTINE_MARKER =
            new CoreStateFiles<>( "quarantine-marker", DATABASE, QuarantineMarker.Marshal.INSTANCE, CoreStateType.QUARANTINE_MARKER );
