...
public class ReplicatedDatabaseState
{
    ...
    private final Map<MemberId,DatabaseState> memberStates;
    private final boolean coreStates;

    private ReplicatedDatabaseState( DatabaseId databaseId, Map<MemberId,DatabaseState> memberStates, boolean isCoreStates )
    {
    ...
    public static ReplicatedDatabaseState ofCores( DatabaseId databaseId, Map<MemberId,DatabaseState> memberStates )
    {
        return new ReplicatedDatabaseState( databaseId, memberStates, true );
    }

    public static ReplicatedDatabaseState ofReadReplicas( DatabaseId databaseId, Map<MemberId,DatabaseState> memberStates )
    {
    ...
    public Map<MemberId,DatabaseState> memberStates()
    {
        return memberStates;
    }

    public Optional<DatabaseState> stateFor( MemberId memberId )
    {
