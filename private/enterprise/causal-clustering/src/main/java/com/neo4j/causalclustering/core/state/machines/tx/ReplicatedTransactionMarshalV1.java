...
import static com.neo4j.causalclustering.core.state.machines.tx.ReplicatedTransactionFactory.transactionalRepresentationWriter;

public class ReplicatedTransactionMarshalV1
{
    private ReplicatedTransactionMarshalV1()
    {
    }

    public static ReplicatedTransaction unmarshal( ReadableChannel channel, String databaseName ) throws IOException
    {
    ...
    public static void marshal( WritableChannel writableChannel, ByteArrayReplicatedTransaction tx ) throws IOException
    {
        int length = tx.getTxBytes().length;
        writableChannel.putInt( length );
        writableChannel.put( tx.getTxBytes(), length );
    }

    public static void marshal( WritableChannel writableChannel, TransactionRepresentationReplicatedTransaction tx ) throws IOException
    {
        ...
        else
        {
            ...
            writeTx( outputStreamWritableChannel, tx.tx() );
