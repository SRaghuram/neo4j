...
import com.neo4j.causalclustering.catchup.storecopy.StoreCopyRequestHandler;
...
//TODO: Remove in favour of MultiDatabaseCatchupServerHandler
public class SingleDatabaseCatchupServerHandler implements CatchupServerHandler
{
    ...
    public SingleDatabaseCatchupServerHandler( Monitors monitors, LogProvider logProvider, Supplier<StoreId> storeIdSupplier,
