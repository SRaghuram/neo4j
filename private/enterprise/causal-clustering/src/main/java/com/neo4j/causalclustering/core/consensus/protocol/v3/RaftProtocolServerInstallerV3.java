...
import com.neo4j.causalclustering.messaging.marshalling.v3.decoding.DecodingDispatcher;
import com.neo4j.causalclustering.messaging.marshalling.v3.decoding.RaftMessageComposer;
...
public class RaftProtocolServerInstallerV3 implements ProtocolInstaller<ProtocolInstaller.Orientation.Server>
{
    private static final ApplicationProtocols APPLICATION_PROTOCOL = ApplicationProtocols.RAFT_3_0;
    private final LogProvider logProvider;

    public static class Factory extends ProtocolInstaller.Factory<Orientation.Server,RaftProtocolServerInstallerV3>
    {
        ...
        {
            super( APPLICATION_PROTOCOL, modifiers -> new RaftProtocolServerInstallerV3( raftMessageHandler, pipelineBuilderFactory, modifiers, logProvider ) );
        }
    }
    ...
    public RaftProtocolServerInstallerV3( ChannelInboundHandler raftMessageHandler, NettyPipelineBuilderFactory pipelineBuilderFactory,
