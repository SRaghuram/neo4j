...
import static com.neo4j.causalclustering.core.consensus.shipping.RaftLogShipper.Mode.CATCHUP;
import static com.neo4j.causalclustering.core.consensus.shipping.RaftLogShipper.Mode.PIPELINE;
import static com.neo4j.causalclustering.core.consensus.shipping.RaftLogShipper.Timeouts.RESEND;
...
public class RaftLogShipper
{
    ...
    private void abortTimeout()
    {
        if ( timer != null )
        {
            timer.cancel( Timer.CancelMode.ASYNC );
        }
