...
import static com.neo4j.causalclustering.error_handling.DatabasePanicEventHandler.stopSnapshotDownloadsHandler;
...
class CorePanicHandlers extends DatabasePanicHandlers
{
    CorePanicHandlers( RaftMachine raftMachine, Database kernelDatabase, CommandApplicationProcess applicationProcess,
            ...
            CoreDownloaderService coreDownloaderService, LogProvider logProvider )
    {
        super( panicService, kernelDatabase.getNamedDatabaseId(), List.of(
                ...
                stopSnapshotDownloadsHandler( coreDownloaderService, logProvider.getLog( CorePanicHandlers.class ) ),
