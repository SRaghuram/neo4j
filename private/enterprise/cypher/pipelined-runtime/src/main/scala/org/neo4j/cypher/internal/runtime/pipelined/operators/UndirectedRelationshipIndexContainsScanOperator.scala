...
class UndirectedRelationshipIndexContainsScanOperator(val workIdentity: WorkIdentity,
                                                      relOffset: Int,
                                                      startOffset: Int,
                                                      endOffset: Int,
  ...
  override protected def nextTasks(state: PipelinedQueryState,
    ...
    singletonIndexedSeq(
      new UndirectedRelationshipIndexContainsScanTask(
...
class UndirectedRelationshipIndexContainsScanTask(inputMorsel: Morsel,
...
class UndirectedRelationshipIndexContainsScanTaskTemplate(inner: OperatorTaskTemplate,
                                                          id: Id,
  ...
  extends DirectedRelationshipIndexContainsScanTaskTemplate(inner,
                                                            id,
                                                            innermost,
                                                            relOffset,
                                                            startOffset,
