...
class DirectedRelationshipIndexContainsScanOperator(val workIdentity: WorkIdentity,
                                                    relOffset: Int,
                                                    startOffset: Int,
                                                    endOffset: Int,
  ...
  override protected def nextTasks(state: PipelinedQueryState,
    ...
    singletonIndexedSeq(
      new DirectedRelationshipIndexContainsScanTask(
...
class DirectedRelationshipIndexContainsScanTask(inputMorsel: Morsel,
