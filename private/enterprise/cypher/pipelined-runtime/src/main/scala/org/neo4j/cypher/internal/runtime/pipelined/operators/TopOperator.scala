...
case class TopOperator(workIdentity: WorkIdentity,
  ...
  class TopReduceOperator(argumentStateMapId: ArgumentStateMapId)
    ...
    override def nextTasks(state: PipelinedQueryState,
                           input: IndexedSeq[TopTable],
                           resources: QueryResources,
                           argumentStateMaps: ArgumentStateMaps): IndexedSeq[ContinuableOperatorTaskWithAccumulators[Morsel, TopTable]] = {
...
object TopOperator {
  ...
  case class ZeroTable(override val argumentRowId: Long,
    ...
    override final def shallowSize: Long = ZeroTable.SHALLOW_SIZE
  }
  ...
  class StandardTopTable(override val argumentRowId: Long,
    ...
    override final def shallowSize: Long = StandardTopTable.SHALLOW_SIZE
  }
  ...
  class ConcurrentTopTable(override val argumentRowId: Long,
    ...
    override final def shallowSize: Long = ConcurrentTopTable.SHALLOW_SIZE
  }
