...
class UndirectedRelationshipIndexEndsWithScanOperator(val workIdentity: WorkIdentity,
                                                      relOffset: Int,
                                                      startOffset: Int,
                                                      endOffset: Int,
  ...
  extends StreamingOperator {
    ...
    override protected def nextTasks(state: PipelinedQueryState,
      ...
      singletonIndexedSeq(
        new UndirectedRelationshipIndexEndsWithScanTask(
...
class UndirectedRelationshipIndexEndsWithScanTask(inputMorsel: Morsel,
                                                  ...
                                                  valueExpr: Expression,
                                                  propertyId: Int)
  extends UndirectedRelationshipIndexStringSearchTask(relOffset,
                                                      startOffset,
                                                      endOffset,
                                                      indexPropertyIndices,
                                                      indexPropertySlotOffsets,
...
class UndirectedRelationshipIndexEndsWithScanTaskTemplate(inner: OperatorTaskTemplate,
                                                          id: Id,
  ...
  extends DirectedRelationshipIndexEndsWithScanTaskTemplate(inner,
                                                            id,
                                                            innermost,
                                                            relOffset,
                                                            startOffset,
