...
object CountingState {
  ...
  abstract class StandardCountingState(override val argumentRowId: Long,
    ...
    override final def shallowSize: Long = StandardCountingState.SHALLOW_SIZE
  }
  ...
  abstract class ConcurrentCountingState(override val argumentRowId: Long,
    ...
    override final def shallowSize: Long = ConcurrentCountingState.SHALLOW_SIZE
  }
...
abstract class SerialCountingOperatorOnRhsOfApplyOperatorTaskTemplate(override val inner: OperatorTaskTemplate,
                                                                      override val id: Id,
                                                                      argumentStateMapId: ArgumentStateMapId,
                                                                      generateCountExpression: () => IntermediateExpression,
