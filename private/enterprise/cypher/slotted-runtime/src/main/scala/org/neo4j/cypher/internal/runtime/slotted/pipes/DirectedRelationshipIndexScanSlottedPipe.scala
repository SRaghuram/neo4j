...
case class DirectedRelationshipIndexScanSlottedPipe(ident: String,
                                                    startNode: String,
                                                    endNode: String,
  ...
  protected def internalCreateResults(state: QueryState): ClosingIterator[CypherRow] = {
    ...
    new SlottedRelationshipIndexIterator(state, slots.getLongOffsetFor(startNode), slots.getLongOffsetFor(endNode), cursor)
  }
}
