...
abstract class AbstractNodeIndexStringScanSlottedPipe(ident: String,
...
case class NodeIndexContainsScanSlottedPipe(ident: String,
                                            label: LabelToken,
                                            property: SlottedIndexedProperty,
                                            queryIndexId: Int,
                                            valueExpr: Expression,
...
case class NodeIndexEndsWithScanSlottedPipe(ident: String,
                                            label: LabelToken,
                                            property: SlottedIndexedProperty,
                                            queryIndexId: Int,
                                            valueExpr: Expression,
