...
class SlottedTCKTests extends EnterpriseBaseTCKTests {
  ...
  @Disabled
  def generateDenylistSlotted(): Unit = {
    printComputedDenylist(scenarios, SlottedTestConfig, () => new TestEnterpriseDatabaseManagementServiceBuilder())
