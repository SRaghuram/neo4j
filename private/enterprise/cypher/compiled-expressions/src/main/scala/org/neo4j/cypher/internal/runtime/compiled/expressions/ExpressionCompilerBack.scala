...
import org.neo4j.cypher.internal.runtime.compiled.expressions.ExpressionCompilerBack.PACKAGE_NAME
import org.neo4j.cypher.internal.runtime.compiled.expressions.ExpressionCompilerBack.className
import org.neo4j.values.AnyValue

/**
  * Compiles [[IntermediateExpression]] into compiled byte code.
  */
class ExpressionCompilerBack(codeGenerationMode: CodeGenerationMode) {
