...
class VarLengthPlanningTest extends ExecutionEngineFunSuite with QueryStatisticsTestSupport with CypherComparisonSupport {
  ...
  test("should handle LIKES*0.LIKES") {
    ...
    //When
    val result = executeWith(Configs.InterpretedAndSlottedAndPipelined, "MATCH (p { id:'n0' }) MATCH (p)-[:LIKES*0]->()-[r:LIKES]->(c) RETURN c")
    //Then
  ...
  test("should handle LIKES.LIKES*0") {
    ...
    makeTreeModel(maxNodeDepth = 4)
    //When
    val result = executeWith(Configs.InterpretedAndSlottedAndPipelined, "MATCH (p { id:'n0' }) MATCH (p)-[:LIKES]->()-[r:LIKES*0]->(c) RETURN c")
    //Then
    result.executionPlanDescription() should haveNoneRelFilter
  }
  ...
  test("should handle LIKES*1.LIKES") {
    ...
    makeTreeModel(maxNodeDepth = 4)
    //When
    val result = executeWith(Configs.InterpretedAndSlottedAndPipelined, "MATCH (p { id:'n0' }) MATCH (p)-[:LIKES*1]->()-[r:LIKES]->(c) RETURN c")
    //Then
    result.executionPlanDescription() should haveNoneRelFilter
  }
  ...
  test("should handle LIKES.LIKES*1") {
    ...
    makeTreeModel(maxNodeDepth = 4)
    //When
    val result = executeWith(Configs.InterpretedAndSlottedAndPipelined, "MATCH (p { id:'n0' }) MATCH (p)-[:LIKES]->()-[r:LIKES*1]->(c) RETURN c")
    //Then
    result.executionPlanDescription() should haveNoneRelFilter
  }
  ...
  test("should handle LIKES*2.LIKES") {
    ...
    makeTreeModel(maxNodeDepth = 4)
    //When
    val result = executeWith(Configs.InterpretedAndSlottedAndPipelined, "MATCH (p { id:'n0' }) MATCH (p)-[:LIKES*2]->()-[r:LIKES]->(c) RETURN c")
    //Then
    result.executionPlanDescription() should haveNoneRelFilter
  }
  ...
  test("should handle LIKES.LIKES*2") {
    ...
    makeTreeModel(maxNodeDepth = 4)
    //When
    val result = executeWith(Configs.InterpretedAndSlottedAndPipelined, "MATCH (p { id:'n0' }) MATCH (p)-[:LIKES]->()-[r:LIKES*2]->(c) RETURN c")
    //Then
    result.executionPlanDescription() should haveNoneRelFilter
  }
  ...
  test("should handle LIKES.LIKES*3") {
    ...
    //When
    val result = executeWith(Configs.InterpretedAndSlottedAndPipelined, "MATCH (p { id:'n0' }) MATCH (p)-[:LIKES]->()-[r:LIKES*3]->(c) RETURN c")
    //Then
    result.executionPlanDescription() should haveNoneRelFilter
  }
  ...
  test("should handle LIKES*1.LIKES.LIKES*2") {
    ...
    makeTreeModel(maxNodeDepth = 5)
    //When
    val result = executeWith(Configs.InterpretedAndSlottedAndPipelined, "MATCH (p { id:'n0' }) MATCH (p)-[:LIKES*1]->()-[:LIKES]->()-[r:LIKES*2]->(c) RETURN c")
    //Then
    result.executionPlanDescription() should haveNoneRelFilter
  }
  ...
  test("should handle LIKES.LIKES*2.LIKES") {
    ...
    makeTreeModel(maxNodeDepth = 5)
    //When
    val result = executeWith(Configs.InterpretedAndSlottedAndPipelined, "MATCH (p { id:'n0' }) MATCH (p)-[:LIKES]->()-[:LIKES*2]->()-[r:LIKES]->(c) RETURN c")
    //Then
    result.executionPlanDescription() should haveNoneRelFilter
  }
