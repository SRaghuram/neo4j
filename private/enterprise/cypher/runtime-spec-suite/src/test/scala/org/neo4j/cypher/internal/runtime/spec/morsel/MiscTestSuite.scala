...
abstract class MiscTestSuite(edition: Edition[EnterpriseRuntimeContext],
                             runtime: CypherRuntime[EnterpriseRuntimeContext]) extends RuntimeTestSuite(edition, runtime) {
