...
class PipelinedRelationshipIndexScanTest extends RelationshipIndexScanTestBase(FUSING, PIPELINED, SIZE_HINT) with PipelinedSpecSuite
class PipelinedRelationshipIndexScanNoFusingTest extends RelationshipIndexScanTestBase(NO_FUSING, PIPELINED, SIZE_HINT) with PipelinedSpecSuite
...
// EAGER
class PipelinedEagerTest extends EagerTestBase(FUSING, PIPELINED, SIZE_HINT) with PipelinedSpecSuite
class PipelinedEagerNoFusingTest extends EagerTestBase(NO_FUSING, PIPELINED, SIZE_HINT) with PipelinedSpecSuite
...
// SET FROM MAP
class PipelinedSetPropertiesFromMapNodeTest extends SetPropertiesFromMapNodeTestBase(FUSING, PIPELINED, SIZE_HINT) with PipelinedSpecSuite
...
class PipelinedSetPropertiesFromMapRelationshipTest extends SetPropertiesFromMapRelationshipTestBase(FUSING, PIPELINED, SIZE_HINT) with PipelinedSpecSuite
...
class PipelinedSetRelationshipPropertyNoFusingTest extends SetRelationshipPropertyTestBase(NO_FUSING, PIPELINED, SIZE_HINT) with PipelinedSpecSuite
class PipelinedSetRelationshipPropertyTest extends SetRelationshipPropertyTestBase(FUSING, PIPELINED, SIZE_HINT) with PipelinedSpecSuite
//EXHAUSTIVE LIMIT
