...
class MorselRelationshipCountFromCountStoreSingleThreadedTest extends RelationshipCountFromCountStoreTestBase(ENTERPRISE.SINGLE_THREADED, MorselRuntime, SIZE_HINT)
class MorselRelationshipCountFromCountStoreSingleThreadedNoFusingTest extends RelationshipCountFromCountStoreTestBase(ENTERPRISE.SINGLE_THREADED_NO_FUSING, MorselRuntime, SIZE_HINT)
class MorselRelationshipCountFromCountStoreParallelTest extends RelationshipCountFromCountStoreTestBase(ENTERPRISE.PARALLEL, MorselRuntime, SIZE_HINT)
class MorselRelationshipCountFromCountStoreParallelNoFusingTest extends RelationshipCountFromCountStoreTestBase(ENTERPRISE.PARALLEL_NO_FUSING, MorselRuntime, SIZE_HINT)
