...
class TransactionBookmarkManagerTest
{
    ...
    void testBasicRemoteBookmarkHandling()
    {
        ...
        assertThat( graph1State, containsInAnyOrder( "BB-3" ) );
        var graph2State = getGraphState( bookmark, graph2 );
        assertThat( graph2State, containsInAnyOrder( "BB-2" ) );
    }
    ...
    void testSubmittedBookmarkHandling()
    {
        ...
        assertThat( getBookmarksForGraph( graph1 ), containsInAnyOrder( "BB-1", "BB-2", "BB-5" ) );
        assertThat( getBookmarksForGraph( graph2 ), containsInAnyOrder( "BB-3", "BB-4" ) );
        ...
        var bookmark = bookmarkManager.constructFinalBookmark();
        var graph1State = getGraphState( bookmark, graph1 );
        assertThat( graph1State, containsInAnyOrder( "BB-6" ) );
        var graph2State = getGraphState( bookmark, graph2 );
        assertThat( graph2State, containsInAnyOrder( "BB-7" ) );
    }
    ...
    void testBookmarkMerging()
    {
        ...
        var bookmark = bookmarkManager.constructFinalBookmark();
        var graph1State = getGraphState( bookmark, graph1 );
        assertThat( graph1State, containsInAnyOrder( "BB-1", "BB-2", "BB-3" ) );
    }
    ...
    void testSystemDbBookmark()
    {
        ...
        assertThat( getBookmarksForGraph( graph1 ), containsInAnyOrder( "BB-1" ) );
    }
