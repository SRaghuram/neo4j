...
public class TransactionBatchCommitterTest
{
    ...
    public void shouldTerminateOutdatedTransactions() throws Exception
    {
        ...
        logProvider.rawMessageMatcher().assertContains( "Marking transaction for termination" );
        logProvider.rawMessageMatcher().assertContains( "lastCommittedTxId:" + (BASE_TX_ID + txCount - 1) );
    }
