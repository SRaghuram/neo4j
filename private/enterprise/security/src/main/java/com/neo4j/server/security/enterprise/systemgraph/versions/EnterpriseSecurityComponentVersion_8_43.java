...
/**
 * This is the EnterpriseSecurityComponent version for Neo4j 4.3.
 */
public class EnterpriseSecurityComponentVersion_8_43 extends SupportedEnterpriseSecurityComponentVersion
{
    private final KnownEnterpriseSecurityComponentVersion previous;

    public EnterpriseSecurityComponentVersion_8_43( Log log, KnownEnterpriseSecurityComponentVersion previous )
    {
        super( ComponentVersion.ENTERPRISE_SECURITY_43, log );
    ...
    {
        previous.setUpDefaultPrivileges( tx );
    ...
    {
        previous.assignDefaultPrivileges( role, predefinedRole );
    }
