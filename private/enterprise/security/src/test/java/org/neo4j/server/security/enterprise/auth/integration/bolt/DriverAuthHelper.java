...
class DriverAuthHelper
{
    ...
    static String boltUri( DatabaseRule databaseRule )
    {
        return "bolt://" + databaseRule.resolveDependency( ConnectorPortRegister.class ).getLocalAddress( "bolt" ).toString();
    }
    ...
    static void assertAuthorizationExpired( Driver driver )
    {
        try ( Session session = driver.session() )
        {
