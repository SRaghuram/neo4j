...
/**
 * Provides test access to {@link DatabaseManagementService} running commercial edition.
 * If you want an impermanent version, see {@link ImpermanentCommercialDbmsExtension}.
 *
...
@ExtendWith( {DefaultFileSystemExtension.class, CommercialDbmsSupportExtension.class} )
public @interface CommercialDbmsExtension
{
    /**
