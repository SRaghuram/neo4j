...
class AkkaCoreTopologyServiceIT
{
    ...
    void setUp()
    {
        ...
        service = (AkkaCoreTopologyService) AKKA.factory().coreTopologyService( config, new TestDiscoveryMember(), jobScheduler, logProvider,
                logProvider, initialDiscoveryMemberResolver, new NoRetriesStrategy(), sslPolicyLoader, new Monitors(), Clocks.systemClock() );
    }
