...
import static com.neo4j.server.security.enterprise.CommercialSecurityModule.IMPORT_AUTH_COMMAND_NAME;
...
{
    public static final String COMMAND_NAME = IMPORT_AUTH_COMMAND_NAME;
    ...
    private static final Arguments arguments = new Arguments()
            .withArgument( new OptionalNamedArg( USER_ARG_NAME, USER_STORE_FILENAME, USER_STORE_FILENAME,
                    "File name of user repository file to import." ))
            .withArgument( new OptionalNamedArg( ROLE_ARG_NAME, ROLE_STORE_FILENAME, ROLE_STORE_FILENAME,
