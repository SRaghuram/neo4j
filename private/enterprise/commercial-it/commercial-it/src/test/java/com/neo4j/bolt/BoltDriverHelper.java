...
{
    private static final Config TEST_DRIVER_CONFIG = Config.builder().withoutEncryption().withLogging( Logging.none() ).build();

    public static Driver graphDatabaseDriver( URI uri )
    {
        return GraphDatabase.driver( uri, TEST_DRIVER_CONFIG );
    }
    ...
    {
        return GraphDatabase.driver( uri, auth, TEST_DRIVER_CONFIG );
    }
