...
public class AkkaTopologyClient extends SafeLifecycle implements TopologyService
{
    ...
    public AkkaTopologyClient( Config config, LogProvider logProvider, JobScheduler jobScheduler, MemberId myself, HostnameResolver hostnameResolver,
            TopologyServiceRetryStrategy topologyServiceRetryStrategy, ActorSystemLifecycle actorSystemLifecycle )
    {
        this.config = config;
