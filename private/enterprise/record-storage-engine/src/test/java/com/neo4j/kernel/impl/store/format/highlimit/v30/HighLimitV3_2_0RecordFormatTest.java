...
public class HighLimitV3_2_0RecordFormatTest extends AbstractRecordFormatTest
{
    public HighLimitV3_2_0RecordFormatTest()
    {
        super( HighLimitV3_2_0.RECORD_FORMATS, 50, 50 );
    }
}
