...
import static org.neo4j.util.TestHelpers.runBackupToolFromSameJvm;
...
public class AdminToolCausalClusterBackupIT
{
    ...
    public void shouldAllowBackupWithTimestampAsName() throws Exception
    {
        ...
        String backupAddress = leader.config().get( OnlineBackupSettings.online_backup_server ).toString();
